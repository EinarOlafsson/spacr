...
- version: **get_version()**
- branch: `nightly` at `fcbc1b55`
- Python modules under `spacr/`: 335
- of those under `spacr/qt/`: 195 (44 screens, 70 widgets)
- test files: 788 (271 under `tests/qt/`)
...
- PASS — task ledger: 4 open, 82 done, all with their sections
