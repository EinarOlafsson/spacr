                        ...
                        try:
                            ...
                            for i, file in enumerate(files):
                                ...
                                if i+1 <= settings['examples_to_plot']:
                                    ...
                                    print(f'({settings["channels"]})')
                                    print(f'({settings["cell_channel"]})')
                                    print(f'({settings["nucleus_channel"]})')
                                    print(f'({settings["pathogen_channel"]})')
                                    print(f'({settings["organelle_channel"]})')
