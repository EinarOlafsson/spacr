...
#: The bounds variable speed sweeps between. SHARED WITH
#: :mod:`spacr.qt.widgets.fractal_travel`, where they bracket that module's
#: own DEFAULT_SPEED of 4.0 and the sweep therefore changes the RANGE rather
#: than the average pace.
#:
#: THEY DO NOT BRACKET THIS MODULE'S DEFAULT, which is 1.0: the backdrop
#: lives behind the interface and was deliberately slowed, while these bounds
#: were carried over unchanged. So switching variable speed ON here does not
