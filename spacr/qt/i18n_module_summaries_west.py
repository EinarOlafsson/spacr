...
MODULE_SUMMARIES_WEST: dict[str, dict[str, str]] = {
    "sv": {
        ...
        "foreign": 'Ta in bilder, masker och mättabeller i ett spaCR-projekt – konvertera mikroskopformat, mappa källkolumner eller använd masker som skapats någon annanstans',
    ...
    "de": {
        ...
        "foreign": 'Bilder, Masken und Messtabellen in ein spaCR-Projekt übernehmen – Mikroskopformate konvertieren, Quellspalten zuordnen oder anderswo erstellte Masken übernehmen',
    ...
    "es": {
        ...
        "foreign": 'Incorpora imágenes, máscaras y tablas de medidas a un proyecto de spaCR: convierte formatos de microscopio, asigna columnas de origen o adopta máscaras creadas en otra herramienta',
