...
MODULE_SUMMARIES_OTHER: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "foreign": 'Traz imagens, máscaras e tabelas de medições para um projeto spaCR — convertendo formatos de microscópio, mapeando colunas de origem ou adotando máscaras criadas noutro local',
    ...
    "is": {
        ...
        "foreign": 'Flyttu myndir, maska og mælingatöflur inn í spaCR-verkefni — með því að umbreyta smásjársniðum, varpa upprunadálkum eða taka upp maska sem gerðir voru annars staðar',
    ...
    "fr": {
        ...
        "foreign": 'Importez images, masques et tables de mesures dans un projet spaCR — en convertissant les formats de microscope, en associant les colonnes source ou en adoptant des masques créés ailleurs',
