...
MODULE_SUMMARIES_ASIA: Dict[str, Dict[str, str]] = {
    "zh_CN": {
        ...
        "foreign": "将外部图像、掩膜和测量表导入 spaCR 项目，并把源列映射到 spaCR 字段",
    ...
    "hi": {
        ...
        "foreign": "बाहरी छवियों, मास्क और मापन तालिका को spaCR परियोजना में आयात करें तथा स्रोत कॉलमों को spaCR फ़ील्ड से मैप करें",
    ...
    "ko": {
        ...
        "foreign": "외부 이미지, 마스크 및 측정 테이블을 spaCR 프로젝트로 가져오고 원본 열을 spaCR 필드에 매핑합니다",
