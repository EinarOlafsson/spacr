"""Preserve the deprecated :mod:`spacr.regression_search` import path.
...
The alias emits one :class:`DeprecationWarning` per import. New code should
import :mod:`spacr.parameter_sweep` and use ``SweepSpace``, ``run_sweep``, and
``summarise_sweep`` directly.
"""
