...
def register_explain_cv_settings(replace: bool = False) -> bool:
    ...
    tooltips = {
        ...
        "surrogate_model": "(str) - Estimator family used to reproduce CV decisions: Random Forest, histogram gradient boosting, or optional XGBoost. Missing XGBoost is refused rather than silently substituted.",
        ...
        "surrogate_exclude": "(list) - Additional measured features barred from the explanatory matrix. Use it for known artifacts or post-treatment annotations; model outputs, classes and identifiers remain excluded automatically.",
