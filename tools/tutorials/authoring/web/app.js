...
const READY = {
  pypi: {
    id: "01_pypi_github",
    title: "PyPI, GitHub & conda-forge",
    duration: "1 min 46 sec",
    durationShort: "1:46",
    description: "Choose among the official PyPI, conda-forge, GitHub Release, and nightly distribution routes.",
    objectives: [
  ...
  conda: {
    ...
    durationShort: "1:05",
    description: "Create an isolated Python 3.12 environment and install spaCR directly from conda-forge.",
    objectives: [
      "Create and activate a dedicated Conda environment.",
      "Install spaCR from the official conda-forge channel.",
      "Verify the package and diagnostics before launch."
    ],
