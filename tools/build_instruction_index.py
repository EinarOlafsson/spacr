...
STAGE: Dict[str, str] = {
    ...
    "306": "API half done; catalog ratchets 27 of 31 green; 6 untranslated rows left of 16 (an earlier count of 803 was wrong -- it skipped the gate's own _looks_translatable filter)",
    "315": "~75% -- 3a/3b/3c fixed; 3d now itemised into three named optimisations",
    "316": "READMEs FIXED -- all nine now match canonical at 35 headings; 32 runtime rows repaired; 15 orphaned blocks retired; 3 blocks need re-translation and ~21 rows say the wrong thing for a microplate well",
