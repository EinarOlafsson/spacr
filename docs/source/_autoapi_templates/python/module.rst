...
----------
            ...
            {% if obj.name == "spacr" %}
The supported workflow modules stay in the main navigation. The complete
directory below remains available for contributors without turning every
implementation module into an implied public contract.
...
.. dropdown:: Complete contributor module directory

               {% for submodule in visible_submodules %}
   * :doc:`{{ submodule.id }} <{{ submodule.include_path }}>`
               {% endfor %}
