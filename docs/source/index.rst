...
The GUI ships 34 apps, grouped into five categories — *Core*, *Data*,
*Segmentation models*, *Results & QC*, and *Toxoplasma*. The nine Core apps
form the main pipeline; these five are the path most screens take, each with
its own :doc:`API reference <api/index>` module:
