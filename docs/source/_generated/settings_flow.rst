...
1061 settings, of 1079 read anywhere.
...
Read by :py:func:`~spacr.settings.get_analyze_plaque_settings`, ``_requested_plaque_model``, :py:func:`~spacr.submodules.analyze_plaques`.
