...
1051 settings, of 1095 read anywhere.
...
Read by ``_trial_settings``, :py:func:`~spacr.parameter_sweep.settings_for_trial`.
...
Read by ``_perform_regression``, ``_run_guide_permutation_analysis``, :py:func:`~spacr.ml.resolve_auto_inference`, ``_resolve_regression_analysis_choices``, :py:func:`~spacr.settings_advisor.refusals`.
...
Read by ``_call_level_hits``, ``_perform_regression``, ``_reconcile_random_row_column_effects``, :py:func:`~spacr.refit.refit_settings`.
...
Read by ``_run_guide_permutation_analysis``, :py:func:`~spacr.ml.resolve_auto_inference`, ``_resolve_regression_analysis_choices``, :py:func:`~spacr.settings.get_setting_dependencies`, :py:func:`~spacr.settings_advisor.refusals`.
...
| :py:func:`~spacr.anndata_export.run_anndata_export`
|     :py:func:`~spacr.anndata_export.anndata_export_settings` **-- reads it**

Read by :py:func:`~spacr.anndata_export.anndata_export_settings`.
...
Read by ``_work``, :py:func:`~spacr.qt.screens.align.write_stack`, :py:func:`~spacr.spacrops.get_preprocess_ops_settings`.
...
Read by :py:func:`~spacr.settings.get_train_test_model_settings`.
...
Read by ``_cross_validate_model``, ``_class_column``, ``_describe_classifier_training``, ``_migrate_control_wells``, :py:func:`~spacr.settings.get_train_test_model_settings`.
...
Read by :py:func:`~spacr.ml.generate_ml_scores`, :py:func:`~spacr.qt.screens.align.write_stack`, :py:func:`~spacr.surrogate.explain_cv_default_settings`, :py:func:`~spacr.utils.add_column_to_database`.
...
Read by ``_calibration_inputs``, ``_perform_regression``, ``_perform_regression_read_data``, ``_show_response_distribution``, ``_write_regression_panel_packages``, :py:func:`~spacr.ml.minimum_cell_simulation`, ``_make_screen``, :py:func:`~spacr.qt.screens.parameter_sweep.apply_settings`, :py:func:`~spacr.qt.widgets.measurement_scan_panel.column_run_settings`.
...
Read by :py:func:`~spacr.annotation_dataset.generate_annotation_dataset`, ``_cross_validate_model``, :py:func:`~spacr.deep_spacr.train_test_model`, :py:func:`~spacr.plot.plot_data_from_db`, :py:func:`~spacr.sequencing_qc.barcode_qc`, :py:func:`~spacr.sequencing_qc.barcode_qc_defaults`, :py:func:`~spacr.submodules.analyze_plaques`, :py:func:`~spacr.submodules.generate_score_heatmap`, :py:func:`~spacr.surrogate.explain_cv_default_settings`.
...
Read by ``_call_level_hits``, ``_perform_regression``, ``_run_guide_permutation_analysis``, ``_write_regression_panel_packages``, :py:func:`~spacr.parameter_sweep.run_sweep`, :py:func:`~spacr.trial_metrics.summarise_trial`.
...
Read by :py:func:`~spacr.deep_spacr.annotate_filter_vision`, ``_perform_regression``, :py:func:`~spacr.sequencing.graph_sequencing_stats`.
...
Read by ``_draw_the_threshold_sweep``, ``_perform_regression``.
...
Read by ``_run_guide_permutation_analysis``, ``_say_what_the_permutation_will_do``.
...
| :py:func:`~spacr.hit_investigation.investigate_hit`
|     :py:func:`~spacr.hit_investigation.hit_investigation_default_settings` **-- reads it**

Read by :py:func:`~spacr.hit_investigation.hit_investigation_default_settings`.
...
Read by :py:func:`~spacr.hit_investigation.hit_investigation_default_settings`, ``_check_app_specific``.
...
Read by ``_perform_regression``, :py:func:`~spacr.ml.resolve_auto_inference`, ``_it_will_permute``, ``_permuted``, :py:func:`~spacr.run_recommendations.recommend`, ``_is_nonparametric``, ``_resolve_regression_analysis_choices``, :py:func:`~spacr.settings.get_setting_dependencies`, :py:func:`~spacr.settings.permutation_active`, :py:func:`~spacr.settings.permutation_is_certain`, :py:func:`~spacr.settings_advisor.refusals`.
...
Read by :py:func:`~spacr.cell_montage.select_montage_per_guide`, ``_perform_regression``, ``_run_guide_permutation_analysis``, ``_announce_the_fit``, ``_say_what_the_permutation_will_do``, ``_why_no_rows_at``, :py:func:`~spacr.refit.refit_settings`, ``_resolve_regression_analysis_choices``, ``_set_analyze_invasion_defaults``, ``_set_analyze_replication_defaults``, :py:func:`~spacr.submodules.analyze_class_proportion`, :py:func:`~spacr.submodules.analyze_endodyogeny`, :py:func:`~spacr.submodules.analyze_invasion`, :py:func:`~spacr.submodules.analyze_replication`.
...
Read by :py:func:`~spacr.core.preprocess_generate_masks`, :py:func:`~spacr.io.preprocess_img_data`, :py:func:`~spacr.settings.get_analyze_plaque_settings`, :py:func:`~spacr.submodules.analyze_plaques`.
...
Read by ``_perform_regression``, :py:func:`~spacr.ml.generate_ml_scores`, :py:func:`~spacr.ml.minimum_cell_simulation`.
...
Read by ``_call_level_hits``, ``_perform_regression``, ``_run_guide_permutation_analysis``, ``_on_refit``.
...
Read by :py:func:`~spacr.hit_investigation.hit_investigation_default_settings`, :py:func:`~spacr.surrogate.explain_cv_default_settings`.
...
Read by ``_write_crop_tar``, ``_crop_settings``.
...
Read by :py:func:`~spacr.surrogate.explain_cv_default_settings`.
...
Read by ``_perform_regression``, ``_reconcile_random_row_column_effects``, :py:func:`~spacr.refit.refit_settings`, ``_level_is_read``, ``_level_reason``, :py:func:`~spacr.settings.get_setting_dependencies`.
...
Read by ``_perform_regression``, ``_announce_the_fit``.
...
Read by :py:func:`~spacr.surrogate.explain_cv_default_settings`, ``_check_app_specific``.
...
Read by ``_perform_regression``, ``_show_response_distribution``, :py:func:`~spacr.settings.get_setting_dependencies`.
