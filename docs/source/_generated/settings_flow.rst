...
1013 settings, of 1057 read anywhere.
...
Read by ``_perform_regression``, ``_run_guide_permutation_analysis``, :py:func:`~spacr.ml.resolve_auto_inference`, ``_resolve_regression_analysis_choices``.
...
Read by ``_run_guide_permutation_analysis``, :py:func:`~spacr.ml.resolve_auto_inference`, ``_resolve_regression_analysis_choices``, :py:func:`~spacr.settings.get_setting_dependencies`.
...
Read by :py:func:`~spacr.batch_correction.correction_kwargs`, ``_perform_regression``, :py:func:`~spacr.settings.get_setting_dependencies`.
...
Read by :py:func:`~spacr.cell_montage.select_montage_per_guide`, ``_perform_regression``, ``_run_guide_permutation_analysis``, ``_say_what_the_permutation_will_do``, ``_why_no_rows_at``, :py:func:`~spacr.refit.refit_settings`, ``_resolve_regression_analysis_choices``, ``_set_analyze_invasion_defaults``, ``_set_analyze_replication_defaults``, :py:func:`~spacr.submodules.analyze_class_proportion`, :py:func:`~spacr.submodules.analyze_endodyogeny`, :py:func:`~spacr.submodules.analyze_invasion`, :py:func:`~spacr.submodules.analyze_replication`.
...
Read by ``_perform_regression``, ``_perform_regression_read_data``, :py:func:`~spacr.ml.normalize_regression_input_pairs`, ``_first_count_file``, :py:func:`~spacr.qt.widgets.measurement_scan_panel.column_run_settings`.
...
Read by :py:func:`~spacr.annotation_dataset.generate_annotation_dataset`, :py:func:`~spacr.core.generate_image_umap`, ``_cross_validate_model``, :py:func:`~spacr.deep_spacr.train_test_model`, :py:func:`~spacr.io.generate_training_dataset`, :py:func:`~spacr.runctx.resolve_seed`, :py:func:`~spacr.sim.run_and_save`, :py:func:`~spacr.stream_dataset.stream_dataset`.
