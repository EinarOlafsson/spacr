...
1075 settings, of 1093 read anywhere.
...
Read by :py:func:`~spacr.settings.get_analyze_plaque_settings`, ``_analyze_plaque_figures``.
...
Read by :py:func:`~spacr.barcode_search.propose_map_barcodes_settings`, :py:func:`~spacr.plot.plot_region`, :py:func:`~spacr.sequencing.generate_barecode_mapping`.
