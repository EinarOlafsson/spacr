# Notes from `spacr/qt/widgets/barcode_regex.py`

Prose lifted out of `spacr/qt/widgets/barcode_regex.py` by `tools/extract_source_notes.py`.
...
- [BarcodeRegexDialog.__init__](#barcoderegexdialog__init__) (3 entries)
...
A real column barcode, gRNA and row barcode from the bundled reference tables, surrounded by the constant sequence expected by the shipped regex.

## BarcodeRegexDialog.__init__
