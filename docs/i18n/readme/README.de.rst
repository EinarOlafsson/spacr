...
Bei der Messung am 2026-09-15 lud der vollständige Klon 5,8 GB herunter. Beim flachen Klon verringerte ``--filter=blob:none`` die gemessene Downloadmenge nicht. Die versionierten Dateien von nightly ergeben ein Arbeitsverzeichnis von 1934 MB (gemessen am 2026-09-25), ohne Git-Verlauf. Downloadmenge und Dauer hängen vom Branch ab.
