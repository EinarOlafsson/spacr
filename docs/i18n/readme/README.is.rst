...
.. |InstallerWindows| image:: ../../../spacr/resources/icons/platforms/windows.png
   :width: 64
   :alt: Sækja spaCR 1.5.1.0 fyrir Windows 10/11
...
.. |InstallerMacOS| image:: ../../../spacr/resources/icons/platforms/macos.png
   :width: 64
   :alt: Sækja spaCR 1.5.1.0 fyrir macOS 11+ (Intel og Apple Silicon)
...
.. |InstallerLinux| image:: ../../../spacr/resources/icons/platforms/linux.png
   :width: 64
   :alt: Sækja spaCR 1.5.1.0 fyrir 64-bita Linux
...
Í mælingunni 2026-09-15 sótti fullt klón 5,8 GB. Í grunna klóninu minnkaði ``--filter=blob:none`` ekki mælt niðurhal. Skrárnar sem Git fylgist með í nightly taka 1642 MB í vinnutrénu (mælt 2026-09-25), án Git-ferilsins. Stærð niðurhals og tími fara eftir greininni.
