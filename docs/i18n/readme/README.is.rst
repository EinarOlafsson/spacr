...
Í mælingunni 2026-09-15 sótti fullt klón 5,8 GB. Í grunna klóninu minnkaði ``--filter=blob:none`` ekki mælt niðurhal. Skrárnar sem Git fylgist með í nightly taka 1934 MB í vinnutrénu (mælt 2026-09-25), án Git-ferilsins. Stærð niðurhals og tími fara eftir greininni.
