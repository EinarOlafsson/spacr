...
En la medición del 2026-09-15, el clon completo descargó 5,8 GB. Añadir ``--filter=blob:none`` al clon superficial no redujo su descarga medida. Los archivos versionados de nightly ocupan 1353 MB en la copia de trabajo (medidos el 2026-09-26), sin el historial de Git. El tamaño y el tiempo de descarga varían según la rama.
