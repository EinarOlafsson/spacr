...
.. |InstallerWindows| image:: ../../../spacr/resources/icons/platforms/windows.png
   :width: 64
   :alt: 下载适用于 Windows 10/11 的 spaCR 1.5.0.6
...
.. |InstallerMacOS| image:: ../../../spacr/resources/icons/platforms/macos.png
   :width: 64
   :alt: 下载适用于 macOS 11+（Intel 和 Apple Silicon）的 spaCR 1.5.0.6
...
.. |InstallerLinux| image:: ../../../spacr/resources/icons/platforms/linux.png
   :width: 64
   :alt: 下载适用于 64 位 Linux 的 spaCR 1.5.0.6
...
捐助者需要历史;只需运行 spaCR,请采取其中一个,测量为 2026-09-14 以 ``packaging/measure_clone_forms.sh``。::
...
完整的克隆下载 5.8 GB 为 941 MB 支票. 添加 ``--filter=blob:none`` 到该克隆节省了什么:支票随之抓住了泡沫。
