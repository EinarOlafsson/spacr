...
Na medição de 2026-09-15, o clone completo baixou 5,8 GB. No clone raso, ``--filter=blob:none`` não reduziu o download medido. Os arquivos versionados de nightly ocupam 1934 MB na cópia de trabalho (medidos em 2026-09-25), sem o histórico do Git. O tamanho e o tempo de download variam conforme a ramificação.
