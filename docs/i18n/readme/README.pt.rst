...
.. |InstallerWindows| image:: ../../../spacr/resources/icons/platforms/windows.png
   :width: 64
   :alt: Baixar o spaCR 1.5.1.0 para Windows 10/11
...
.. |InstallerMacOS| image:: ../../../spacr/resources/icons/platforms/macos.png
   :width: 64
   :alt: Baixar o spaCR 1.5.1.0 para macOS 11+ (Intel e Apple Silicon)
...
.. |InstallerLinux| image:: ../../../spacr/resources/icons/platforms/linux.png
   :width: 64
   :alt: Baixar o spaCR 1.5.1.0 para Linux de 64 bits
...
Na medição de 2026-09-15, o clone completo baixou 5,8 GB. No clone raso, ``--filter=blob:none`` não reduziu o download medido. Os arquivos versionados de nightly ocupam 1642 MB na cópia de trabalho (medidos em 2026-09-25), sem o histórico do Git. O tamanho e o tempo de download variam conforme a ramificação.
