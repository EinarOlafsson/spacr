...
KEYS_BEFORE_REGROUP = frozenset({
    ...
    "cell_min_area", "cell_min_watershed_distance", "cell_min_intensity_percentile",
    ...
    "nucleus_min_area", "nucleus_min_watershed_distance", "nucleus_min_intensity_percentile",
    ...
    "organelle_min_area", "organelle_min_watershed_distance", "organelle_min_intensity_percentile",
    ...
    "pathogen_min_area", "pathogen_min_watershed_distance", "pathogen_min_intensity_percentile",
