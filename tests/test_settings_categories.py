...
KEYS_BEFORE_REGROUP = frozenset({
    ...
    "cell_background", "cell_chann_dim", "cell_channel",
    "cell_diameter", "cell_intensity_merge", "cell_intensity_threshold",
    "cell_intensity_range", "cell_intensity_split",
    "cell_loc", "cell_mask_dim", "cell_max_area",
    "cell_min_area", "cell_min_watershed_distance",
    "cell_minimum_area_to_split", "cell_min_size", "cell_perimeter_fraction", "cell_plate_metadata",
    ...
    "nucleus_background", "nucleus_chann_dim", "nucleus_channel",
    "nucleus_diameter", "nucleus_intensity_merge", "nucleus_intensity_threshold",
    "nucleus_intensity_range", "nucleus_intensity_split",
    "nucleus_loc", "nucleus_mask_dim", "nucleus_max_area",
    "nucleus_min_area", "nucleus_min_watershed_distance",
    "nucleus_minimum_area_to_split", "nucleus_min_size", "nucleus_perimeter_fraction",
    ...
    "organelle_adaptive_offset", "organelle_chann_dim",
    ...
    "organelle_hysteresis_high", "organelle_hysteresis_low", "organelle_intensity_merge", "organelle_intensity_threshold",
    ...
    "organelle_max_area", "organelle_method",
    "organelle_min_area", "organelle_min_watershed_distance",
    "organelle_minimum_area_to_split", "organelle_min_area", "organelle_model_name",
    ...
    "pathogen_signal_to_noise", "pathogen_background",
    "pathogen_chann_dim", "pathogen_channel", "pathogen_diameter", "pathogen_intensity_merge", "pathogen_intensity_threshold",
    "pathogen_intensity_range", "pathogen_intensity_split",
    "pathogen_limit", "pathogen_loc",
    "pathogen_mask_dim", "pathogen_max_area",
    "pathogen_min_area", "pathogen_min_watershed_distance",
    "pathogen_minimum_area_to_split", "pathogen_min_size", "pathogen_model",
