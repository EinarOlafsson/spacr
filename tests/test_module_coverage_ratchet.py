...
def test_current_packaging_denominator_is_639_not_asset_generators():
    """The ratchet follows all 639 shipped modules, not asset generators.
    ...
    # 545 -> 546 on 2026-09-08: `spacr/qt/screens/settings_flow_index.py`,
    # generated by `tools/settings_flow.py --rst` beside the settings-flow
    # page and imported by the settings panel to decide whether a setting
...
def test_coverage_workflow_is_sharded_artifact_safe_and_blocking():
    ...
    assert "--expected-file-count 639" in combine_script
