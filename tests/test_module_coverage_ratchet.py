...
def test_current_packaging_denominator_is_513_not_asset_generators():
    """The ratchet follows all 513 shipped modules, not asset generators.
...
def test_coverage_workflow_is_sharded_artifact_safe_and_blocking():
    ...
    assert "--expected-file-count 513" in combine_script
