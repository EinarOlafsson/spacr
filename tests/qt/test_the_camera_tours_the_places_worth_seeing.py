...
# ---------------------------------------------------------------------------
# THE WIRE IS TESTED NEXT DOOR, in
# `test_the_camera_tours_the_twenty_regions.py`. Eight tests lived here
# briefly on 2026-09-10 against a SECOND implementation of the same wiring,
# written in this session without seeing that the other one had already
# shipped `TourPilot` the evening before. They were removed with it: one
# implementation, and its tests beside it.
# ---------------------------------------------------------------------------
