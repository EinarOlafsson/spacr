...
def test_the_screen_offers_and_runs_otsu_with_no_model(
    ...
    added organelle detection's own methods, which are scikit-image and
    need nothing installed, so they are listed and RUNNABLE here.
    """
    ...
    try:
        ...
        assert [made._mag_mode.itemData(i)
            ...
            "otsu", *mm.organelle_modes.modes(), *mm._MAGNIFIER_BACKENDS]
