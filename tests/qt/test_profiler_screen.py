...
def test_the_screen_registers_itself_through_the_seam():
    ...
    from spacr.qt.app import (APPS, SECTION_TOOLS, SECTION_ORDER,
                              registered_factory)
    ...
    # Tools since 571b6e77c, with investigate_hit and train_compare.
    assert row[3] == SECTION_TOOLS
    assert SECTION_TOOLS in SECTION_ORDER
