...
HOST_APP_KEYS = {
    "10_classify_cv": "classify_merged",
    "11_classify_ml": "classify_merged",
    "16_activation": "classify_merged",
    "17_timelapse": "mask",
    "18_motility": "measure",
    "19_train_cellpose": "make_masks",
    "20_cellpose_masks": "make_masks",
    "21_model_compare": "make_masks",
    "22_model_zoo": "make_masks",
    "23_agreement": "annotate",
    "39_classifier_evaluation": "classify_merged",
    "42_curate": "make_masks",
    "43_illumination": "measure",
    "47_barcode_qc": "map_barcodes",
    "55_image_scatter": "umap",
    "59_anndata_export": "measure",
    "60_pca": "umap",
    "70_explain_cv": "classify_merged",
    "72_volcano_explorer": "regression",
    "73_parameter_sweep": "regression",
}
...
def test_all_authored_catalogs_match_the_73_lesson_inventory_and_routes():
    ...
    for locale in FULL_LOCALES:
        ...
        assert routes == HOST_APP_KEYS, locale
