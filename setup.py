...
setup(
    ...
    package_data={'spacr': ['resources/release_notes.json', 'resources/tutorial_index.json', 'resources/data/*', 'resources/models/cp', 'resources/icons/*.png', 'resources/icons/loading_spinner.gif', 'resources/font/**/*', 'resources/images/*', 'resources/themes/*.jpg', 'resources/setting_animations/*.json', 'resources/setting_animations/gifs/*.gif'],},
    data_files=(
        [
            ('share/applications', [
